    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    <h4 class="header-title"> Create Investment Schemes </h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.investment_scheme.store') }}" method="POST" id="form" data-parsley-validate>
                        @csrf
                        <div class="form-row">
                       ...
                       <!-- <div class="form-row">
                        ...
                        <button type="submit" class="btn btn-primary  pr-4 pl-4"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;Create Scheme</button>
