    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Report -  Loan OverDue Report</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="">Dashboard</a></li>
                    <!-- <li><a href="">All Blogs</a></li> -->
                    <li><span>OverDue Report Details</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    ...
    <div class="card mt-5">
        <div class="card-body card-b">
         <div class='d-flex justify-content-between align-items-center'>
           <h4 class="header-title">Search loan overdue</h4>
           <div class="toggle">
    ...
    <div class="card mt-5">
        <div class="card-body" style="border-top: 2px solid #8914fe;
         box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
        <div>
        <h4 class="header-title">OverDue Report Details</h4>
   ...
   $(document).ready(function(){
    ...
    $("#pdf_export").click(function(){
       ...
       // $("#export").attr("href","./emi_due_report_export/"+from_date+"/"+to_date+"/"+branch);
        $("#pdf_export").attr("href","./emi_overdue_report_exportPdf/"+from_date+"/"+to_date+"/"+branch);
