    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Report -  Loan Due Report</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="">Dashboard</a></li>
                    <!-- <li><a href="">All Blogs</a></li> -->
                    <li><span>Due Report Details</span></li>
                </ul>
            </div>
        </div>
...
$(document).ready(function(){
    ...
    // $("#search_by_branch option:selected").each(function() {
...
<script>
   $(document).ready(function(){
    $("#export").click(function(){
       ...
       // $("#pdf_export").attr("href","./emi_due_report_exportPdf/"+from_date+"/"+to_date+"/"+branch);
