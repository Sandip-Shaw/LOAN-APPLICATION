...
@section('title')
Edit Journal Entry - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Edit Journal Entry</h4>
                    ...
                    <form action="" method="POST" id="form"  data-parsley-validate>
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                <input type="date" class="form-control" id="date" name="entry_date" value="{{$entries->entry_date}}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <select name="branch" id="branch" class="form-control" required>
                                    ...
                                    <option value="{{$branch}}" {{$entries->branch==$branch?'selected':''}}>{{$key}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                <textarea id="summernote" name="Description"  class="form-control" placeholder="Enter Description" required>{{$entries->description}}</textarea> 
                                </div>
                            </div>
                           ...
                           <div class="form-group row">
                             <label  for="Debit" class="col-sm-2 col-form-label" style="text-align: right"><b>Debit</b><span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                ...
                                <div class="col-sm-8" style="display:flex;">
                                    ...
                                    @foreach($branches as $key=>$branch)
                                    <option value="{{$branch}}" {{$entries->branch1==$branch?'selected':''}}>{{$key}}</option>
