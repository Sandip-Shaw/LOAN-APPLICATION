        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span> Approval Reports</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="card" >
        <div class="card-body card-b" >
         <div class='d-flex justify-content-between align-items-center'>
           <h4 class="header-title">Search Loan Approval Reports</h4>
           <div class="toggle">
        ...
        <div class="col-12 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                ...
                <div class="card-body">
                    <div>
                    <h4 class="header-title float-left"> Approval Report's List</h4>
                    <div class="text-right">
                <a href="" id="export" class="btn btn-danger btn-sm" style="text-align: right;"><i class="fa fa-download" aria-hidden="true"></i>Download CSV</a>
   ...
   $(document).ready(function(){
    $("#export").click(function(){
       ...
       // console.log(from_date);
        $("#export").attr("href","./approval_report_export/"+from_date+"/"+to_date+"/"+branch);
    })
    ...
    $("#pdf_export").click(function(){
       ...
       // console.log(from_date);
        $("#pdf_export").attr("href","./approval_report_exportPdf/"+from_date+"/"+to_date+"/"+branch);
    })
})
