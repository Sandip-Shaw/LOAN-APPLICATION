    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">ADD LEDGER </h4>
        ...
        <div class="col-md-7">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ledger_account.store') }}" method="POST" id="form" data-parsley-validate>
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Ledger Display Name" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" id="system_name" name="system_name" placeholder="Enter Ledger System Name" required>
                                <span style="color:blue; font-size: 12px;">(e.g. Accumulated Depreciation - Vehicles)</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row"style="display:flex"> 
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_bank_account" value="Yes" >
                                    <label class="form-check-label" for="is_bank_account">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_bank_account" value="No" checked>
                            ...
                            <div class="form-group row"style="display:flex"> 
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="show_in_day_book" value="Yes" >
                                    <label class="form-check-label" for="show_in_day_book">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="show_in_day_book" value="No" checked>
                            ...
                            <div style="text-align:center;">
                                <button type="button" class="btn btn-primary  pr-4 pl-4" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;Add Account </button>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" >
                                        ...
                                        <div class="modal-body">
                                                Are you sure to add new Ledger Account?
                                          
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;Add Account </button>
