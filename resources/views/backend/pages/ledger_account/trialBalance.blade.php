    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">TRIAL BALANCE</h4>
    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    <h4 class="header-title float-left">BALANCE</h4>
                                    ...
                                    <tbody>
                                       @foreach($ledger as $ledgers)
                                        <tr>
                                            ...
                                            <td>{{$ledgers->opening_acc_balance}}</td>
                                            <td>{{$ledgers->total_debit}}</td>
                                            <td>{{$ledgers->total_credit}}</td>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$assets->opening_acc_balance}}</td>
                                            <td>{{$assets->total_debit}}</td>
                                            <td>{{$assets->total_credit}}</td>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$liabilities->opening_acc_balance}}</td>
                                            <td>{{$liabilities->total_debit}}</td>
                                            <td>{{$liabilities->total_credit}}</td>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$equities->opening_acc_balance}}</td>
                                            <td>{{$equities->total_debit}}</td>
                                            <td>{{$equities->total_credit}}</td>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$expens->opening_acc_balance}}</td>
                                            <td>{{$expens->total_debit}}</td>
                                            <td>{{$expens->total_credit}}</td>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$revenues->opening_acc_balance}}</td>
                                            <td>{{$revenues->total_debit}}</td>
                                            <td>{{$revenues->total_credit}}</td>
