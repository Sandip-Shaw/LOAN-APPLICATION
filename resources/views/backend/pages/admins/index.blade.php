                        ...
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    ...
                                    <th width="10%">User Login Name</th>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('admin.edit'))
                                            <a href="{{ route('admin.admins.edit', $admin->id) }}"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>&nbsp; &nbsp;
                                        @endif
                                        <a href="{{ route('admin.admins.show', $admin->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        
                                        @if (Auth::guard('admin')->user()->can('admin.delete'))
                                        <a class="pl-2" href="{{ route('admin.admins.destroy', $admin->id) }}"
