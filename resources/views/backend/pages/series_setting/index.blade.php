                    ...
                    <table class="text-center">
                            ...
                            <tbody id="code_details">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="code_prefix[]" id="code_prefix" value="{{$series[0]->code_prefix}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                        &nbsp;
                                        <td>
                                            <input type="text" name="no_of_digit[]" id="no_of_digit" value="{{$series[0]->no_of_digit}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                        &nbsp;
                                        <td>
                                            <input type="text" name="start_digits[]" id="start_digits" value="{{$series[0]->start_digits}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="code_prefix[]" id="code_prefix" value="{{$series[1]->code_prefix}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                        
                                        <td>
                                            <input type="text" name="no_of_digit[]" id="no_of_digit" value="{{$series[1]->no_of_digit}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                        <td>
                                            <input type="text" name="start_digits[]" id="start_digits" value="{{$series[1]->start_digits}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="code_prefix[]" id="code_prefix" value="{{$series[2]->code_prefix}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                        
                                        <td>
                                            <input type="text" name="no_of_digit[]" id="no_of_digit" value="{{$series[2]->no_of_digit}}" class="form-control" readonly/>&nbsp;
                                        </td>
                                        <td>
                                            <input type="text" name="start_digits[]" id="start_digits" value="{{$series[2]->start_digits}}" class="form-control" readonly/>&nbsp;
                                        </td>
