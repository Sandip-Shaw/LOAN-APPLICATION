    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">EDIT LEDGER GROUP</h4>
        ...
        <div class="col-md-7">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ledger_group.update',$group->id) }}" method="POST" id="form" data-parsley-validate>
                        @csrf
                        @method('PUT')
                            <div class="form-group row">
                                ...
                                <select name="group_type" id="group_type" class="form-control" required>
                                    ...
                                    @foreach($type as $typees)
                                    <option value="{{$typees->ledger_types_id}}"{{$group->group_type==$typees->ledger_types_id?'selected':''}}>{{$typees->types}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{$group->display_name}}" id="display_name" name="display_name" placeholder="Enter Group Display Name" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{$group->system_name}}" id="system_name" name="system_name" placeholder="Enter System Name" required>
                                <span style="color:blue; font-size: 12px;">(e.g. Current Assets)</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{$group->position}}" id="position" name="position" placeholder="Enter Weight-age/ Position" required>
                            ...
                            <div class="form-group row"style="display:flex"> 
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="system_group" value="Yes" {{ $group->system_group == 'Yes' ? 'checked' : ''}}>
                                    <label class="form-check-label" for="system_group">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="system_group" value="No" {{ $group->system_group == 'No' ? 'checked' : ''}}>
                            ...
                            <div style="text-align:center;">
                                ...
                                <button type="button" class="btn btn-primary  pr-4 pl-4" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Update Group </button>
