                    ...
                    @csrf
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="group_name" name="group_name" value="{{ $group->group_name }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="date" class="form-control" id="op_date" name="op_date" value="{{ $group->op_date }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="group_branch" id="group_branch" class="form-control" disabled>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="group_leader_name" name="group_leader_name" value="{{ $group->group_leader_name }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="{{ $group->mobile_no }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="group_address" name="group_address" value="{{ $group->group_address }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="assign_employee" id="assign_employee" class="form-control" disabled>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="collection_day" id="collection_day" class="form-control" disabled>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="time" class="form-control" id="collection_time" name="collection_time" value="{{ $group->collection_time }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="leader_photo" class="control-label">Leader Photo</label>
                                @if(isset($group))
                    ...
                    <form action="" method="post" id="form" data-parsley-validate>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="member_name" name="member_name" placeholder="" disabled>
                            </div>
                        </div>
                        ...
                        <div style="text-align:center;">
                        <button type="submit" class="btn btn-primary  pr-4 pl-4" disabled>Add to Queue</button>
