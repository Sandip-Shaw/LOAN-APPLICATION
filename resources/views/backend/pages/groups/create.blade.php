        ...
        <div class="col-md-6 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                ...
                <h4 class="header-title">Group Details</h4>
                    ...
                    <form action="{{ route('admin.groups.store') }}" method="POST" id="form" enctype="multipart/form-data" data-parsley-validate>
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="date" class="form-control" id="op_date" name="op_date" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="group_branch" id="group_branch" class="form-control" required>
                                    ...
                                    @foreach($branch as $group_branch)
                                        <option value="{{$group_branch->branch_name}}" >{{$group_branch->branch_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="group_leader_name" name="group_leader_name" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="group_address" name="group_address" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="file" name="leader_photo" class="" id="group_photo"/>  
                            </div> 
                        </div> 
                        

                        <div style="text-align:center;">
                        <button type="submit" class="btn btn-primary  pr-4 pl-4"><i class="fa fa-bookmark" aria-hidden="true"></i>&nbsp;Create Group </button>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="search_by_member" id="search_by_member" class="form-control" required>
                                    ...
                                    @foreach($members as $key=>$search_by_member)
                                    <option value="{{$search_by_member}}" >{{$key}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
