        ...
        <div class="col-12 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.salary_details.update',$salary->id) }}" method="POST" id="form" enctype="multipart/form-data" data-parsley-validate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <option value="">Select Employee</option>
                                    ...
                                    <option value="{{$hrmanagement->hrmanagement_id}}" @php if($salary->employee==$hrmanagement->hrmanagement_id) echo "selected";  @endphp >{{$hrmanagement->emp_code}}-{{$hrmanagement->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="basic" name="basic"  value="{{$salary->basic}}" placeholder="Enter Amount" required>
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="others">Others<span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                <input type="text" class="form-control" id="others" name="others" value="{{$salary->others}}" placeholder="Enter Amount"required>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="HRA" name="HRA" value="{{$salary->HRA}}" placeholder="Enter Amount" required>
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="fuel">Fuel<span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                <input type="text" class="form-control" id="fuel" name="fuel" value="{{$salary->fuel}}" placeholder="Enter Amount">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="DA" name="DA"  value="{{$salary->DA}}"placeholder="Enter Amount" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="allowance">Allowance<span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                <input type="text" class="form-control" id="allowance" name="allowance" value="{{$salary->allowance}}" placeholder="Enter Amount" required>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="TA" name="TA" value="{{$salary->TA}}" placeholder="Enter Amount" required>
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="gross_pay">Gross Pay <span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                <input type="text" class="form-control" id="gross_pay" name="gross_pay" value="{{$salary->gross_pay}}" readonly>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" class="form-control" id="PF" name="PF" value="{{$salary->PF}}" placeholder="Enter Amount">
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="ESI">ESI <span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                <input type="text" class="form-control" id="ESI" name="ESI" value="{{$salary->ESI}}" placeholder="Enter Amount">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" class="form-control" id="net_pay" name="net_pay" value="{{$salary->net_pay}}" readonly>
                            </div>
                        ...
                        <button type="submit"  class="btn btn-primary  pr-4 pl-4"><i class="fa fa-bookmark" aria-hidden="true"></i>&nbsp;Edit</button>
