        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Employee Holiday Master</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    <h4 class="header-title float-left">Employee's Holiday Detail List</h4>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <td>
                                <a href="{{ route('admin.holiday_master.edit', $holidays->id) }}"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>
