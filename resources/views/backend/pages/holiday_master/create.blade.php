        ...
        <div class="col-md-7">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.holiday_master.store') }}" method="post" data-parsley-validate>
                        @csrf
                            ...
                            <div style="text-align:center;">
                                ...
                                <a class="btn btn-danger" href="{{route('admin.holiday_master.index')}}"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Cancel </a>
