        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Create Employees Leave</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card" style="border-top: 2px solid #8914fe; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.07);">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.employee_leave.store') }}" method="POST" id="form" enctype="multipart/form-data" data-parsley-validate>
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <select id="financialYear" class="form-control" name="financial_year"></select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="cl" name="cl" placeholder="Enter No of CL" required>
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="sl">SL<span style="color:red; font-size: 18px;line-height:1">*</span></label>
                                <input type="text" class="form-control" id="sl" name="sl" placeholder="Enter No of SL"required>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="el" name="el" placeholder="Enter No of EL" required>
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="lop">LOP <span>(If none, write 0)</span></label>
                                <input type="text" class="form-control" id="lop" name="lop" placeholder="Enter No of LOP">
                            </div>
                        ...
                        <button type="submit"  class="btn btn-primary  pr-4 pl-4"><i class="fa fa-bookmark" aria-hidden="true"></i>&nbsp;Save </button>
                        <a class="btn btn-danger" href="{{route('admin.employee_leave.index')}}"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Cancel</a>
